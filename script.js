...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // Initialise tsParticles background if the library is available. The
  // configuration defines a subtle constellation of circles connected by
  // faint lines. Should the library be missing (e.g. offline), this call
  // fails silently and the gradient background remains.
  try {
